 ...
 *
 * When converting durations from/to strings, this class
 * uses seconds. This is primarily because seconds are easier
 * to handle client-side than ISO-8601 durations.
 */
abstract class AbstractDurationProperty extends AbstractProperty<Duration> {
  ...
  protected @Nullable Duration convertFromString(@Nullable String value) {
    return value != null ? Duration.ofSeconds(Long.parseLong(value.trim())) : null;
  }
