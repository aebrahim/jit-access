...
public record Policy(
  ...
  public record Entitlement(
    ...
    static Entitlement from(EntitlementsElement entitlementElement) throws PolicyException {
      ...
      try {
        ...
        if (entitlementElement.requestableBy == null ||
          entitlementElement.requestableBy.principals == null ||
          entitlementElement.requestableBy.principals.isEmpty()) {
        ...
        return new Entitlement(
          ...
          expiry,
          PrincipalSet.from(entitlementElement.requestableBy.principals));
      }
  ...
  record PolicyElement(
    @JsonProperty("id") String id,
    @JsonProperty("name") String name,
    @JsonProperty("entitlements") List<EntitlementsElement> entitlements
    ) {}

  record EntitlementsElement(
    @JsonProperty("id") String id,
    @JsonProperty("name") String name,
    @JsonProperty("expires_after") String expiry,
    @JsonProperty("requestable_by") RequestableByElement requestableBy,
    @JsonProperty("approvable_by") ApprovableBy approvableBy
  ) {}

  record RequestableByElement(
  ...
  public abstract static class PolicyException extends Exception {
